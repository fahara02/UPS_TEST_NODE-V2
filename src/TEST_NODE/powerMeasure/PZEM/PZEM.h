...
class PZEM
{
  public:
	...
	PZEM(uint8_t receivePin, uint8_t transmitPin, uint8_t addr = PZEM_DEFAULT_ADDR);
  ...
  private:
	...
	bool sendCmd(FunctionCode cmd, uint16_t rAddr, uint16_t value, bool check = false,
