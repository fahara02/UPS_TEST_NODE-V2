...
enum class Event : EventBits_t {
  ...
  NETWORK_CONNECTED = 1 << 4,     // 00000000000000000000000000010000
  ...
  REPORT_COMPLETE = 1 << 21,      // 00000000001000000000000000000000
  USER_TUNE = 1 << 22,            // 00000000010000000000000000000000
  RESTART = 1 << 23               // 00000000100000000000000000000000
};
