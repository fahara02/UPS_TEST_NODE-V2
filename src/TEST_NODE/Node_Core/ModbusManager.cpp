...
// uint16_t HREG_START_ADDRESS_DATA = HREG_START_ADDRESS_SETTING + NUM_HOLDREGS_SETTING;
...
// 					SwitchTestData::SingleTest& test = testData.switchTest[switchTestIndex];
// 					switch(subIndex)
// 					{
// 						case 0:
// 							val = test.testNo;
...
// 		}
// 	}
// 	else if(address >= HREG_START_ADDRESS_SETTING && address < HREG_START_ADDRESS_DATA)
// 	{
